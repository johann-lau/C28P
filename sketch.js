...
function setup() {
  ...
  board2 = new Board(width - 450, height - 650, 50, 200);
}
...
function gameOver() {
  swal({title:"No remaining arrows!", text:"You got a score of "+score+".", imageURL:"assets/board.png", imageSize:"150x150", confirmButtonText:"Restart"}, isConfirm)
}
